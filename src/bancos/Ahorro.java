...
public class Ahorro extends Cuentas {
    ...
    protected int fechavencio = 0;
    protected float porcentajeIm = 0;
    ...
    public void ConsultarDatos() {
       ...
       /* for (int i = 0; i < NC; i++) {
            System.out.println("Fecha de vencimiento de ahorro: " +NCuentas[i].get));
            System.out.println("Interes mensual de la cuenta de ahorro: " + porcentajeIm + "%");
        }*/
    ...
    public void DepositarSaldo() {
        ...
        System.out.print("ingrese el año actual:");
        NumAno = leer.nextInt();
        Interes = (float) ((porcentajeIm * Saldo) / 100);
        if (NumDia == 1) {
            Saldo = Saldo - porcentajeIm;
